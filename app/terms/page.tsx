...
export default function TermsOfServicePage() {
  return (
    <div className="min-h-screen bg-white">
      {/* Header */}
      <section className="py-16 px-6 bg-surface border-b border-gray-200">
      ...
      <section className="py-16 px-6">
        <div className="max-w-4xl mx-auto prose prose-lg">
          ...
          <p className="text-text-secondary mb-4">To use our services, you must:</p>
          ...
          <h2 className="text-2xl font-bold text-text-primary mb-4">3. Wholesale Orders</h2>
          <h3 className="text-xl font-semibold text-text-primary mb-3">Minimum Order Quantity (MOQ)</h3>
          ...
          <h3 className="text-xl font-semibold text-text-primary mb-3">Order Confirmation</h3>
          <p className="text-text-secondary mb-6">
          ...
          <h2 className="text-2xl font-bold text-text-primary mb-4">4. Pricing and Payment</h2>
          <h3 className="text-xl font-semibold text-text-primary mb-3">Pricing</h3>
          <p className="text-text-secondary mb-4">All prices are:</p>
          <ul className="list-disc pl-6 text-text-secondary mb-6 space-y-2">
          ...
          <h3 className="text-xl font-semibold text-text-primary mb-3">Payment Terms</h3>
          <p className="text-text-secondary mb-4">We accept the following payment methods:</p>
          <ul className="list-disc pl-6 text-text-secondary mb-6 space-y-2">
          ...
          <h2 className="text-2xl font-bold text-text-primary mb-4">5. Shipping and Delivery</h2>
          <h3 className="text-xl font-semibold text-text-primary mb-3">Shipping Methods</h3>
          <p className="text-text-secondary mb-4">We offer various shipping options including:</p>
          <ul className="list-disc pl-6 text-text-secondary mb-6 space-y-2">
          ...
          <h3 className="text-xl font-semibold text-text-primary mb-3">Delivery Time</h3>
          <p className="text-text-secondary mb-4">
          ...
          <h3 className="text-xl font-semibold text-text-primary mb-3">Customs and Duties</h3>
          <p className="text-text-secondary mb-6">
          ...
          <h2 className="text-2xl font-bold text-text-primary mb-4">6. Product Quality and Compliance</h2>
          <p className="text-text-secondary mb-4">All our products:</p>
          <ul className="list-disc pl-6 text-text-secondary mb-6 space-y-2">
          ...
          <h2 className="text-2xl font-bold text-text-primary mb-4">7. Returns and Refunds</h2>
          <h3 className="text-xl font-semibold text-text-primary mb-3">Return Policy</h3>
          <p className="text-text-secondary mb-4">Due to the nature of our products:</p>
          <ul className="list-disc pl-6 text-text-secondary mb-6 space-y-2">
          ...
          <h2 className="text-2xl font-bold text-text-primary mb-4">8. OEM/ODM Services</h2>
          <p className="text-text-secondary mb-4">For custom manufacturing services:</p>
          <ul className="list-disc pl-6 text-text-secondary mb-6 space-y-2">
          ...
          <div className="bg-surface p-6 rounded-lg mb-6">
            <p className="text-text-secondary mb-2"><strong>Email:</strong> colinliyuan@gmail.com</p>
            <p className="text-text-secondary mb-2"><strong>WhatsApp:</strong> +86 138 2442 3871</p>
            <p className="text-text-secondary"><strong>Address:</strong> Dongguan, Guangdong, China</p>
          </div>
        </div>
      </section>
    </div>
