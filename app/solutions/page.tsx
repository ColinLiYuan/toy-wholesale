    ...
    <div className="min-h-screen bg-white">
      <section className="relative py-20 px-6 bg-surface border-b border-gray-200">
        <div className="max-w-7xl mx-auto text-center">
          <div className="inline-flex items-center px-4 py-2 rounded-full border border-brand/30 bg-brand/5 mb-6">
            <span className="text-sm text-brand font-medium tracking-wide">Tailored Wholesale Solutions</span>
          </div>
        ...
        <div className="max-w-7xl mx-auto">
          <div className="grid md:grid-cols-2 gap-8">
            {solutions.map((solution, index) => (
              <div key={index} className="group bg-white rounded-2xl border border-gray-200 hover:border-brand/30 hover:shadow-lg transition-all duration-300 p-8 md:p-10">
                <h3 className="text-2xl font-bold text-text-primary mb-4">{solution.title}</h3>
                <p className="text-text-secondary mb-6 leading-relaxed">{solution.description}</p>
                ...
                <Link href="/contact" className="inline-flex items-center font-semibold text-brand hover:text-brand-hover transition-colors">
                  Learn More
      ...
      <section className="py-20 px-6 bg-brand text-white text-center">
        <div className="max-w-4xl mx-auto">
          ...
          <Link href="/contact" className="inline-flex items-center justify-center px-10 py-5 rounded-lg bg-white text-brand font-bold text-lg hover:bg-gray-100 transition-all shadow-lg">
            Contact Our Team
