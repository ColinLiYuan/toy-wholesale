...
export const metadata: Metadata = {
  ...
  openGraph: {
    title: 'OEM/ODM Services — Custom Adult Toy Branding | SinTone',
...
export default function OemOdmPage() {
  return (
    <div className="min-h-screen bg-white">
      {/* Hero Section */}
      <section className="relative py-20 px-6 bg-gradient-to-br from-brand to-brand-hover text-white">
      ...
      <section className="py-20 px-6">
        <div className="max-w-7xl mx-auto">
          <div className="grid md:grid-cols-2 gap-12 items-center mb-20">
            <div>
              <h2 className="text-4xl font-bold text-text-primary mb-6">Your Brand, Your Product, Your Market</h2>
              ...
              <div className="grid grid-cols-2 gap-4">
                <div className="bg-surface rounded-xl p-4 text-center">
                  ...
                  <div className="text-sm text-text-secondary">Partner Factories</div>
                </div>
                <div className="bg-surface rounded-xl p-4 text-center">
                  <div className="text-3xl font-bold text-brand">7-15</div>
                  <div className="text-sm text-text-secondary">Day Sample Turnaround</div>
                </div>
                <div className="bg-surface rounded-xl p-4 text-center">
                ...
                <div className="bg-surface rounded-xl p-4 text-center">
                  ...
                  <div className="text-sm text-text-secondary">Custom SKUs Delivered</div>
                </div>
              </div>
            </div>
            <div className="bg-gradient-to-br from-surface to-gray-200 rounded-2xl p-8 border border-gray-200">
              <div className="aspect-video bg-white rounded-xl flex items-center justify-center mb-6 shadow-sm">
                <div className="text-center p-8">
                  <svg className="w-24 h-24 mx-auto text-brand/30 mb-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
      ...
      <section className="py-20 px-6 bg-surface">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-16">
            <h2 className="text-4xl font-bold text-text-primary mb-4">OEM Services</h2>
      ...
      <section className="py-20 px-6">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-16">
            <h2 className="text-4xl font-bold text-text-primary mb-4">ODM Services</h2>
            <p className="text-xl text-text-secondary max-w-3xl mx-auto">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            {[
              ...
              <div key={idx} className="bg-surface rounded-xl p-8 border border-gray-200 hover:shadow-lg transition-shadow">
                <h3 className="text-xl font-bold text-text-primary mb-3">{service.title}</h3>
                <p className="text-text-secondary text-sm leading-relaxed mb-6">{service.desc}</p>
                <div className="space-y-3">
                  {service.steps.map((step, i) => (
                    <div key={i} className="flex items-center text-sm">
                      <span className="w-6 h-6 rounded-full bg-brand text-white text-xs flex items-center justify-center mr-3 flex-shrink-0">{i + 1}</span>
      ...
      <section className="py-20 px-6 bg-surface">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-16">
            <h2 className="text-4xl font-bold text-text-primary mb-4">Our OEM/ODM Process</h2>
            <p className="text-xl text-text-secondary max-w-3xl mx-auto">
            ...
            {[
              ...
              <div key={phase.step} className="flex gap-6 mb-8">
                <div className="flex flex-col items-center">
                  <div className="w-12 h-12 rounded-full bg-brand text-white font-bold text-lg flex items-center justify-center flex-shrink-0">
                    {phase.step}
                  </div>
                  {phase.step < 5 && <div className="w-0.5 h-full bg-brand/20 mt-2" />}
                </div>
                <div className="pb-8">
      ...
      {/* CTA */}
      <section className="py-20 px-6 bg-gradient-to-br from-brand to-brand-hover text-white text-center">
        <div className="max-w-4xl mx-auto">
          ...
          <a
            href="/contact"
            className="inline-flex items-center justify-center px-10 py-5 rounded-lg bg-white text-brand font-bold text-lg hover:bg-gray-100 transition-all shadow-lg"
          >
