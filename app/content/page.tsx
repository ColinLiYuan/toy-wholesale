...
export const metadata: Metadata = {
  title: 'SinTone Wholesale - Premium Adult Toys at Wholesale Prices',
  ...
  openGraph: {
    title: 'SinTone Wholesale - Premium Adult Toys Distributor',
    description: 'Premium adult wellness products for global wholesale distribution',
    type: 'website',
    siteName: 'SinTone Wholesale',
  },
  twitter: {
    card: 'summary_large_image',
    title: 'SinTone Wholesale',
