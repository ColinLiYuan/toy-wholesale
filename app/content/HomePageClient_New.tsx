            ...
            <div className="space-y-8">
              <div className="space-y-6">
                <h1 className="text-5xl md:text-6xl lg:text-7xl font-bold leading-tight tracking-tight text-[#1A1A1A]">
                  Premium Sexual<br />Wellness Manufacturing.
                </h1>
                
                <p className="text-xl md:text-2xl text-[#6C757D] leading-relaxed max-w-2xl">
                  OEM/ODM solutions for global adult toy brands. Medical-grade materials, discreet shipping, and zero-compromise quality.
                </p>
              </div>
        ...
        <div className="max-w-7xl mx-auto px-6 lg:px-8">
          <div className="grid grid-cols-2 md:grid-cols-4 gap-8">
            <div className="flex items-center space-x-3">
              ...
              <div>
                <div className="text-sm font-semibold text-[#1A1A1A]">FDA/CE/RoHS</div>
                <div className="text-xs text-[#6C757D]">Certified</div>
              </div>
            </div>
            ...
            <div className="flex items-center space-x-3">
              ...
              <div>
                ...
                <div className="text-xs text-[#6C757D]">From 50 pcs</div>
              </div>
            </div>
            ...
            <div className="flex items-center space-x-3">
              ...
              <div>
                <div className="text-sm font-semibold text-[#1A1A1A]">Medical Grade</div>
                <div className="text-xs text-[#6C757D]">100% Silicone</div>
              </div>
            </div>
            ...
            <div className="flex items-center space-x-3">
              ...
              <div>
                <div className="text-sm font-semibold text-[#1A1A1A]">White Label</div>
                <div className="text-xs text-[#6C757D]">Custom Packaging</div>
              </div>
            </div>
          </div>
        </div>
