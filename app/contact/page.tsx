        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-12">
            ...
            <div className="bg-surface rounded-xl p-8 border border-gray-200">
              ...
              <div className="space-y-6">
                <div className="flex items-start space-x-4">
                  <svg className="w-6 h-6 text-brand mt-1 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M3 8l7.89 5.26a2 2 0 002.22 0L21 8M5 19h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z" />
                  </svg>
                  <div>
                    <h3 className="font-medium text-text-primary mb-1">Sales Email</h3>
                    <a href="mailto:colinliyuan@gmail.com" className="text-text-secondary hover:text-brand transition-colors text-sm">
                ...
                <div className="flex items-start space-x-4">
                  <svg className="w-6 h-6 text-brand mt-1 flex-shrink-0" fill="currentColor" viewBox="0 0 24 24">
                  ...
                  <div>
                    <h3 className="font-medium text-text-primary mb-1">WhatsApp</h3>
                    <a href="https://wa.me/13824423871" target="_blank" rel="noopener noreferrer" className="text-text-secondary hover:text-brand transition-colors text-sm">
                      +86 138 2442 3871
                    </a>
                  </div>
                </div>
                ...
                <div className="flex items-start space-x-4">
                  ...
                  <div>
                    ...
                    <p className="text-text-secondary text-sm">Dongguan, Guangdong, China</p>
                    <p className="text-text-secondary text-xs mt-1">Supply chain hub with direct factory access</p>
                  </div>
                </div>
              </div>
            </div>
            ...
            <div className="bg-brand rounded-xl p-8 text-white">
              ...
              <ul className="space-y-3 text-sm">
                ...
                <li className="flex items-start space-x-2">
                  ...
                  <span>Fast global shipping worldwide</span>
                </li>
                <li className="flex items-start space-x-2">
                  <svg className="w-5 h-5 mt-0.5 flex-shrink-0" fill="currentColor" viewBox="0 0 20 20">
                    <path fillRule="evenodd" d="M16.707 5.293a1 1 0 010 1.414l-8 8a1 1 0 01-1.414 0l-4-4a1 1 0 011.414-1.414L8 12.586l7.293-7.293a1 1 0 011.414 0z" clipRule="evenodd" />
          ...
          <div className="lg:col-span-2">
            <div className="bg-white rounded-xl p-8 border border-gray-200 shadow-sm">
              <h2 className="text-2xl font-semibold text-text-primary mb-6">Send Inquiry</h2>
              ...
              {success && (
                <div className="mb-6 bg-green-50 border-l-4 border-green-500 p-4 rounded">
                  <div className="flex items-center">
                    ...
                    <span className="text-green-700">Inquiry sent successfully! We'll get back to you shortly.</span>
                  </div>
                </div>
              )}
              ...
              <form onSubmit={handleSubmit} className="space-y-6">
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  <div>
                    <label htmlFor="customerName" className="block text-sm font-medium text-text-primary mb-2">
                  ...
                  <div>
                    <label htmlFor="customerEmail" className="block text-sm font-medium text-text-primary mb-2">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  <div>
                    <label htmlFor="customerPhone" className="block text-sm font-medium text-text-primary mb-2">
                      Phone / WhatsApp
                    </label>
                    <input
                      type="tel"
                ...
                <button
                  type="submit"
                  disabled={loading}
                  className="w-full bg-brand text-white py-4 px-6 rounded-lg font-semibold hover:bg-brand-hover focus:outline-none focus:ring-2 focus:ring-brand focus:ring-offset-2 transition-colors disabled:opacity-50 disabled:cursor-not-allowed flex items-center justify-center"
                >
                  {loading ? (
                    <>
